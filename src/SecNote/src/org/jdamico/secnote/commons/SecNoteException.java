...
public class SecNoteException extends Exception {

	private static final long serialVersionUID = -9217036014255738309L;
	
	public SecNoteException(){
		super();
	}
	
	public SecNoteException(Exception e){
		super(e);
	}
	
	public SecNoteException(String message){
		super(message);
	}
	
	public SecNoteException(String message, Exception e){
		super(message, e);
	}
